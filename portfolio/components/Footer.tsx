...
const Footer = async () => {
    const repoStats = await fetch(
        'https://api.github.com/repos/akanaskhan/portfolio',
        {
            next: {
        ...
        <footer className="text-center pb-5" id="contact">
            <div className="container">
                ...
                <a
                    ...
                    className="text-2xl md:text-3xl lg:text-4xl font-anton inline-block mt-5 mb-10 hover:underline"
                >
                    {GENERAL_INFO.email}
                </a>
                ...
                <div className="">
                    <a
                        href="https://github.com/akanaskhan"
                        target="_blank"
                        className="leading-none text-muted-foreground hover:underline hover:text-white"
                    >
                        Design & Developed by Anas Khan
                        <div className="flex items-center justify-center gap-5 pt-1">
                            <span className="flex items-center gap-2">
                                <Star size={18} /> 5{stargazers_count}
                            </span>
                            <span className="flex items-center gap-2">
                                <GitFork size={18} /> 2{forks_count}
                            </span>
                        </div>
                    </a>
